...
from src.configuration.domain.loadconfiguration import LoadConfiguration


class LoadJsonConfiguration(LoadConfiguration):
    ...
    def load_from_str(self, json_str: str) -> Dict:
