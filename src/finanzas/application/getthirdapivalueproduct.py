...
from src.finanzas.infrastructure.thirdapi.investingrepository import InvestingRepository
from src.finanzas.infrastructure.thirdapi.yahoofinancesrepository import YahooFinancesRepository
