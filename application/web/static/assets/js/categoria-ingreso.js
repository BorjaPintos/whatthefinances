...
render_nombre_cuenta = function (data, type) {
    ...
    if (data == undefined)
        new_data = "Todas"
    if (type === 'display'){
        return '<span class="badge badge-success-lighten">'+new_data+'</span>'
    }
    return new_data
}
...
$( document).ready(function() {
    ...
    table = $('#lista_tabla').DataTable({
        ajax: {
            url:'/finanzas/categoria_ingreso',
            dataSrc: '',
        },
        columns: [
            {
            ...
            {
                data:'nombre_cuenta_abono_defecto',
                type: "string",
        ...
        scrollX: false,
        language: {
            info: 'Total _MAX_ Categorías ingreso',
            infoEmpty: 'No hay Categorías ingreso',
    ...
    table.on( 'draw', function () {
        ...
        $('.edit-element').on( "click", function() {
            ...
            var cuenta = data.id_cuenta_abono_defecto
