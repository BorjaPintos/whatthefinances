class CategoriaIngreso:
    ...
    def __init__(self, params: dict):
        ...
        self._nombre_cuenta_abono_defecto = params.get("nombre_cuenta_abono_defecto")
    ...
    def set_id_cuenta_abono_defecto(self, id_cuenta_abono_defecto: int):
        self._id_cuenta_abono_defecto = id_cuenta_abono_defecto

    def get_nombre_cuenta_abono_defecto(self) -> str:
        return self._nombre_cuenta_abono_defecto
    ...
    def get_dto(self) -> dict:
        return {"id": self._id,
                ...
                "nombre_cuenta_abono_defecto": self._nombre_cuenta_abono_defecto,
