...
render_actions = function (data, type, row) {
    if (type === 'display') {
        ...
        if (data != 0) {
            movimientos = '<a class="movimientos-element font-18 text-info me-2" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Movimientos" data-bs-original-title="Movimientos" href="movimientos-cuenta.html?id_cuenta='+data+'"><i class="uil uil-exchange-alt"></i></a>'
