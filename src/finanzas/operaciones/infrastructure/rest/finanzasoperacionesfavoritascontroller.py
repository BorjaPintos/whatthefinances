from src.finanzas.operaciones.application.createoperacionfavorita import CreateOperacionFavorita
from src.finanzas.operaciones.application.deleteoperacionfavorita import DeleteOperacionFavorita
from src.finanzas.operaciones.application.getoperacionfavorita import GetOperacionFavorita
from src.finanzas.operaciones.application.listoperacionesfavoritas import ListOperacionesFavoritas
from src.finanzas.operaciones.application.updateoperacionfavorita import UpdateOperacionFavorita
from src.finanzas.operaciones.infrastructure.persistence.operacionfavoritarepositorysqlalchemy import \
